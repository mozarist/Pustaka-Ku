<div
    ...
    <div class="flex gap-5 items-center">
        ...
        <a href=""
            class="bg-white hover:bg-zinc-50 hover:scale-105 transition w-fit text-emerald-700 text-xs md:text-base px-4 md:px-6 py-2 border border-zinc-300 rounded-lg">
            Pinjaman buku anda
        </a>
    </div>
</div>
