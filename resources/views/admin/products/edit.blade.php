                ...
                <div class="order-2 md:order-1 w-full md:w-2/3 space-y-4 w-full">
                    ...
                    <label class="block mb-4">
                        ...
                        <textarea name="deskripsi"
                            ...
                            rows="8"
                            class="mt-1 pb-3 block w-full rounded-lg bg-transparent border border-zinc-700 px-3 py-2 placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-600">{{ $product->deskripsi }}</textarea>
                    </label>
                </div>
